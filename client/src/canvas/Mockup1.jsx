...
const Mockup = () => {
  ...
  return (
    ...
    <div className='flex w-full h-fit'>
      <div className='relative overflow-hidden bg-white h-80 w-full'>

          {/* <img className='absolute' style={{left:mockupAtr.mockupXposition+"%",top:mockupAtr.mockupYposition+"%"}} 
          src={snap.logoDecal} alt="" width={`${mockupAtr.size}%`}    />  */}
        ...
        className=' h-24 border rounded cursor-pointer'
         ...
         />
          ...
          <div onClick={()=>inputRef.current.click()}  className='w-24 h-24 text-white bg-gray-300 border-2 hover:text-blue-400 er-2 text hover:border-blue-400 rounded cursor-pointer'>
            ...
            <path d="M12.4142 5H21C21.5523 5 22 5.44772 22 6V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 
            2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3H10.4142L12.4142 5ZM4 5V19H20V7H11.5858L9.58579 5H4ZM13
             13V17H11V13H8L12 9L16 13H13Z"></path></svg>     
