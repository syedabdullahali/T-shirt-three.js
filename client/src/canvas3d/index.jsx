...
{/* <Environment preset="city" background /> */}
    ...
    <div id='parent' className="flex flex-col h-full p-2 border " onClick={HnadaleButtonClick}>
      <button className={`${snap.position==='Front'?"bg-blue-100 border-blue-400":""} w-full p-3 mb-3 text-[0.9rem] border`}>Front</button>
      <button className={`${snap.position==='Back'?"bg-blue-100 border-blue-400":""} w-full p-3 mb-3 text-[0.9rem] border`}>Back</button>
      <button className={`${snap.position==='360'?"bg-blue-100 border-blue-400":""} w-full p-3 mb-3 text-[0.9rem] border`}>360</button>
      <button className={`${snap.position==='Left'?"bg-blue-100 border-blue-400":""} w-full p-3 mb-3 text-[0.9rem] border`}>Left</button>
      <button className={`${snap.position==='Right'?"bg-blue-100 border-blue-400":""} w-full p-3 mb-3 text-[0.9rem] border`}>Right</button>
